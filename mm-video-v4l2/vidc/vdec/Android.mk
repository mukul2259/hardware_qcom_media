...
libmm-vdec-inc          += $(TOP)/hardware/qcom-caf/msm8994/media/mm-video-v4l2/vidc/common/inc
libmm-vdec-inc          += $(TOP)/hardware/qcom-caf/msm8994/media/mm-core/inc
...
libmm-vdec-inc      	+= $(TOP)/hardware/qcom-caf/msm8994/media/libc2dcolorconvert
libmm-vdec-inc      	+= $(TOP)/frameworks/av/include/media/stagefright
libmm-vdec-inc      	+= $(TARGET_OUT_HEADERS)/mm-video/SwVdec

ifeq ($(PLATFORM_SDK_VERSION), 18)  #JB_MR2
libmm-vdec-def += -DANDROID_JELLYBEAN_MR2=1
libmm-vdec-inc += $(TOP)/hardware/qcom-caf/msm8994/media/libstagefrighthw
endif
